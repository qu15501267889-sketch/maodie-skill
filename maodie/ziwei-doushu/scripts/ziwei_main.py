...
# 时辰对照
SHICHEN = {
    '子': (23, 0, 0, 59), '丑': (1, 0, 2, 59), '寅': (3, 0, 4, 59),
    '卯': (5, 0, 6, 59), '辰': (7, 0, 8, 59), '巳': (9, 0, 10, 59),
    '午': (11, 0, 12, 59), '未': (13, 0, 14, 59), '申': (15, 0, 16, 59),
    '酉': (17, 0, 18, 59), '戌': (19, 0, 20, 59), '亥': (21, 0, 22, 59),
}
...
def hour_to_shichen(hour, minute):
    ...
    for dz, (sh, sm, eh, em) in SHICHEN.items():
        if sh <= hour < eh or (sh == 23 and hour >= 23):
            return dz
    return '子'  # default
